...
export default function HarmonyEditMenu({ device, buttonStyle, buttonText, areaData, refetchData, updateSelected }) {
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <TextField
                        ...
                        id="ipAddress"
                        label="Unique ID"
                        defaultValue={device.ipAddress.split(":")[0]}
                        InputProps={{
                            readOnly: true,
                        }}
                        fullWidth
                    ...
                    <FormControl
                        ...
                        <Select
                            ...
                            {areaData.areaNames.map(area => <MenuItem key={area + "HarmonyPopUp"} value={area}>{area}</MenuItem>)}
                        </Select>
                    </FormControl>
                    <TextField
                        variant="filled"
