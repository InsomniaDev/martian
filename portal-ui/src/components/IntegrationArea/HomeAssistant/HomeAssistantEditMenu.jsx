...
export default function HomeAssistantEditMenu({ device, buttonStyle, buttonText, areaData, refetchData, updateSelected }) {
                ...
                <DialogContent>
                    ...
                    <FormControl
                        ...
                        <Select
                            ...
                            {areaData.areaNames.map(area => <MenuItem key={area + "hassPopUp"} value={area}>{area}</MenuItem>)}
                        </Select>
                    </FormControl>
                    <TextField
                        variant="filled"
